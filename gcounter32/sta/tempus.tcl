...
read_verilog ../syn/outputs/gcounter32_netlist.v
set_top_module gcounter32

read_sdc ../syn/outputs/gcounter32_constraints.sdc
read_sdf ../syn/outputs/gcounter32_delays.sdf
